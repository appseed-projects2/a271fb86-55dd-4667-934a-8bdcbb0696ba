...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-04-15 09:25`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/a271fb86-55dd-4667-934a-8bdcbb0696ba.git
$ cd a271fb86-55dd-4667-934a-8bdcbb0696ba
```
